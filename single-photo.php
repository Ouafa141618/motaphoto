        ...
        <div class="post-image">
            <?php if (has_post_thumbnail()) : ?>
                <figure class="photo1 brightness">
                    ...
                    <div>
                        <a href="#" class="openLightbox gallery-fullscreen" aria-label="Afficher en plein écran" data-src="<?php the_post_thumbnail_url(); ?>" data-reference="<?php the_field('reference'); ?>"></a>
                    </div>
                </figure>
            <?php endif; ?>
        </div>
        ...
        <div class="photo_choix">
            <div class="photo_avant">
                ...
                if (!empty($prev_post)) {
                    ...
                    previous_post_link('<span class="left"><img src="' . $prev_image . '" alt="' . $prev_post->post_title . '" width="75" height="75"/> <a href="' . get_permalink($prev_post) . '" rel="prev"><img src="' . get_stylesheet_directory_uri() . '/images/fleche-gauche.png"></a></span>', '%title', false);
                }
                ?>
            </div>
            <div class="photo_apres">
                ...
                if (!empty($next_post)) {
                    ...
                    next_post_link('<span class="right"><img src="' . $next_image . '" alt="' . $next_post->post_title . '" width="75" height="75"/> <a href="' . get_permalink($next_post) . '" rel="next"><img src="' . get_stylesheet_directory_uri() . '/images/fleche-droite.png"></a></span>', '%title', false);
                }
                ?>
            </div>
        </div>
...
<section class="photo_detail">
    ...
    <div class="btn-all-photos">
        <button id="all-photos" type="button">
            <a href="<?php echo site_url('/photos'); ?>" aria-label="Page d'accueil de Nathalie Mota">Toutes les photos</a>
        </button>
    </div>
</section>
<?php get_footer(); ?>
